...
// Estilos para el PDF (mismo esquema de color y estructura que OrdenTrabajoPDF.jsx)
...
const MantenimientoPreventivoPDF = ({ mantenimiento }) => {
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.headerRow}>
          <Text style={styles.headerRowText}>Fecha: {formatearFecha(mantenimiento.fecha)}</Text>
          <Text style={styles.title}>MANTENIMIENTO PREVENTIVO</Text>
          <Text style={styles.headerRowText}>N.º {mantenimiento.numero || ''}</Text>
        </View>
        ...
        <View style={styles.horizontalInfoBlocks}>
          <View style={[styles.infoBlock, { flex: 1 }]}>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.value}>{mantenimiento.cliente?.nombre || ''}</Text>
            </View>
            <View style={styles.infoRow}>
              <Text style={styles.label}>Empresa:</Text>
              <Text style={styles.value}>{mantenimiento.cliente?.empresa || ''}</Text>
            </View>
            <View style={styles.infoRow}>
              <Text style={styles.label}>Dirección:</Text>
              <Text style={styles.value}>{mantenimiento.cliente?.direccion || ''}</Text>
            </View>
            {mantenimiento.cliente?.sedeNombre && (
              <View style={styles.infoRow}>
                <Text style={styles.label}>Sede:</Text>
                <Text style={styles.value}>{mantenimiento.cliente.sedeNombre}</Text>
              </View>
            )}
          </View>
        </View>
        ...
        {mantenimiento.observaciones && (
          <View style={styles.notes}>
            ...
            <Text style={styles.colContent}>{mantenimiento.observaciones}</Text>
          </View>
        )}
        ...
        <View style={styles.firmasRow} wrap={false}>
          <View style={styles.firmaBlock}>
            {mantenimiento.firmaTecnico && <Image src={mantenimiento.firmaTecnico} style={styles.firmaImagen} />}
            <Text style={styles.firmaLinea}>Firma del técnico</Text>
            <Text style={styles.firmaAclaracion}>{mantenimiento.aclaracionFirmaTecnico || 'Sin aclaración'}</Text>
          </View>
          <View style={styles.firmaBlock}>
            {mantenimiento.firmaCliente && <Image src={mantenimiento.firmaCliente} style={styles.firmaImagen} />}
            <Text style={styles.firmaLinea}>Conformidad del cliente</Text>
            <Text style={styles.firmaAclaracion}>{mantenimiento.aclaracionFirmaCliente || 'Sin aclaración'}</Text>
          </View>
        </View>
...
export default MantenimientoPreventivoPDF;
